...
有对白，有特效，有背景，有返回。
~~其实原版的主题自带的也可以的话说咳咳~~
想看效果的话可以浏览器打开`wansz.xyz/404.html`
或者点击→[hey][1]
...
<head>
    ...
    <meta name="keywords" content="晚书04提醒!" />
	<meta name="description" content="晚书404提醒!" />
	<meta name="author" content="晚书404提醒!" />
    <meta name="copyright" content="晚书404提醒!" />
...
div#background{background:url(https://buyao.mobi/i/2020/02/25/a6cqgf6.jpg) no-repeat;-webkit-animation:dd 100s linear infinite;-moz-animation:dd 100s linear infinite;-o-animation:dd 100s linear infinite;animation:dd 100s linear infinite;background-size:cover}
...
.main{z-index:999;width:100%;max-width:300px;height:80px;padding:30px;background-color:#0000001f;border-radius:2px;box-shadow:0 10px 60px 0 rgba(29,29,31,.09);transition:all .12s ease-out;position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;}
.alert{width:80px}
...
.return-home{text-decoration:none;color:#fff;font-size:16px}
#site-footer{position: absolute;z-index: 999;bottom:0;width: 100%;}
#site-footer {
	font-size: 13px;
	margin-top: 10px;
	text-align: center;
...
<div class="index">
                <div><a href="https://wansz.xyz" class="return-home">返回Blog</a></div>
</div>
    <div class="main">
        
                <div><a href="404.html" class="return-home a1"></a></div>
        <div style="text-align: right;"><a href="404.html" class="return-home a2"></a></div>
    </div>
    </div>
<script>
window.onload=function () {
    var hitokoto = document.querySelector('.a1');
    var from = document.querySelector('.a2');
    var bk  = document.getElementById('background');
    update();
    function update() {
        gethi = new XMLHttpRequest();
        gethi.open("GET","https://v1.hitokoto.cn/?c=d");
        gethi.send();
        gethi.onreadystatechange = function () {
            if (gethi.readyState===4 && gethi.status===200) {
                ...
                from.innerHTML = "from:" + Hi.from; //可自定义输出格式
            }
        }
    }
}
...
<footer id="site-footer">
    <a target="_blank" href="https://wansz.xyz" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#fff;">这里辛落</p></a><br>
</footer>
</body>
</html>
```
